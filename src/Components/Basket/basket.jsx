...
function Basket() {
    ...
    return (
        <div className={style.container}>
           <img onClick={henddleClick} className={style.basket} src={basket} alt="basket" /> 
           <div className={`${style.basketMenu} ${style[open]}`}>
            ...
            <div className={style.basketInner}>
                ...
                <button onClick={henddleClick} className={style.btn}>Continue shopping</button>
            </div>
           </div>
           <div className={open === '' ? '' : style.overlay}>
           </div>
        </div>        
    )
}
